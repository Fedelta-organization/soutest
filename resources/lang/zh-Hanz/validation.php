...
return [
    ...
    */
	...
	'max'                  => [
		...
		'string'  => '对于 :attribute，请指定小于或等于 :max 个字符的字符串。',
	...
	'min'                  => [
		...
		'string'  => '请为 :attribute 指定 :min 个或更多字符的字符串。',
	...
	'regex'                => '请以正确的格式指定 :attribute。',
	'required'             => ':attribute 属性是必需的。',
	...
	'size'                 => [
		...
		'string'  => '请为 :attribute 指定一串 :size 字符。',
		'array'   => ':attributeには:size個の要素を持つ配列を指定してください。',
	],
	'string'               => '请为 :attribute 指定一个字符串。',
